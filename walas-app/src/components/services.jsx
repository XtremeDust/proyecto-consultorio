...
function services() {
    return (
        <div className='bg-white py-16 sm:py-16 rounded-3xl shadow-xl'>
            <div className='mx-auto max-w-screen-2xl px-6 lg:px-8 sm:flex-col sm:flex sm:justify-center'>

                <div className='mx-auto max-w-full lg:mx-0'>
                    <h2 className='text-4xl font-semibold tracking-tight text-pretty lg:text-justify text-center text-gray-900 sm:text-5xl'>
                        Sobre nuestro Servicios
                    </h2>
                    <p className='m-5 sm:mx-20 text-lg/6 text-gray-600 lg:text-justify text-center '>
                ...
                <div className='mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-8 border-t border-gray-200 pt-5 sm:mt-5 sm:pt-5 lg:mx-0 lg:max-w-none lg:grid-cols-3'>
                    {post.map((post) => (
